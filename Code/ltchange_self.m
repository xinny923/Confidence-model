...
%     selfC_data = selfC_data(ind,:);
    ...
    x1_mean = (0:20)';
    y1_mean = mean(selfC_data(:,1:21),1);
    mdl1 = fitlm(x1_mean,y1_mean);
    r1 = mdl1.Rsquared.Ordinary;
    x2_mean = (20:30)';
    y2_mean = mean(selfC_data(:,21:end),1);
